...
final case class Update(req: ScanamoUpdateRequest)
    extends ScanamoOpsA[ScanamoResult[UpdateItemResult]]
...
object ScanamoOps {
  ...
  def update(
    ...
    liftF[ScanamoOpsA, ScanamoResult[UpdateItemResult]](Update(req))
}
